...
if opts.plot:
    ...
    # TODO: Find or create the mystical dataPlotter class
...
def position_estimate(messages, satinfo):
    ...
    if 'NAV_POSECEF' in messages:
        ...
        print("posdiff=%f pos=%s avg=%s %s" % (
        posdiff, pos.ToLLH(), satinfo.average_position.ToLLH(), time.ctime(satinfo.raw.gps_time)))
    else:
